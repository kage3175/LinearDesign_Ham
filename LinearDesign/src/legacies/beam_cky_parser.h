...
public:
    ...
    std::vector<std::pair<IndexType, IndexType>> penalty_vec;
    //==========================================================================
...
private:
    ...
    bool is_penalty(IndexType i) {
        if(penalty_mode == PENALTY_ON){
            for(const auto& pair: penalty_vec) {
        ...
        // if (penalty_mode == PENALTY_ON && penalty_start <= i && i <= penalty_end)
        //     return true;
        // return false;
    }
    ...
    bool is_penalty(IndexType i, IndexType j) {
        ...
        // if (penalty_mode == PENALTY_ON && !is_penalty(i) && is_penalty(j))
        //     return true;
        // if (penalty_mode == PENALTY_ON && is_penalty(i) && !is_penalty(j))
        //     return true;
        return false;
